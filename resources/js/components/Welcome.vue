        ...
        <div id = "myCarousel" class = "carousel slide mb-5" data-action="carousel">
            <ol class = "carousel-indicators">
                ...
                <div class = "carousel-item active">
                    <svg class = "bd-placeholder-img" width="100%" height="80%" xmlns = "" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect width="100%" height="100%" fill="#777"/> </svg>
                </div>
                <div class = "container">
                    <div class = "carousel-caption text-lg-left">
                        ...
                        <button type="button" class="btn btn-outline-success mr-0 btn-lg" href="#">Hire A Freelancer</button>
                        <button type="button" class="btn btn-outline-success mr-0 btn-lg" href="#">Earn Money Freelancing</button>
                    </div>
                </div>
        </div>
        <hr>
