        ...
        <div class="col-md-12">
            ...
            <div class="col-12 table-responsive">
                <div class="card-body table table-responsive table-borderless p-0">
                    <bootstrap-table :data="awardedProjects" :options="myOptions" :columns="myColumns" sticky-header responsive borderless/>
                </div>
            </div>
        </div>
                ...
                myColumns: [
                    ...
                    {field: 'project.description', title: 'Project Description'},
                    {
                        ...
                        formatter: function (e, value, row) {
                            ...
                            return '<a class="btn btn-sm accept bg-lancer text-white" data-toggle="modal" data-target="#">Accept</a> '+
                                ' <a class="btn btn-sm decline bg-danger" data-toggle="modal" data-target="#">Decline</a>'
                        },
                        events: {
                            'click .accept': function (e, value, row) {
                                Fire.$emit('acceptJob', row);

                            },
                            'click .decline': function (e, value, row) {
