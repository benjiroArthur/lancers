        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow pro-card">
                    <div v-if="AllProject.length > 0" class="row">
                        <div v-for="(project, i) in AllProject" class="col-md-3" :key="i">
                            <div class="card shadow-lg" :class="singlePro(project.job_offered.status)" >
                                <h4>{{project.title}}</h4>
                                <p></p>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            getAllProject(){
                axios
                    .get('/data/client/projects/'+this.$parent.userId)
                    .then((response)=>{
            ...
            getInProgress(){
                axios
                    .get('/data/client/in-progress/'+this.$parent.userId)
                    .then((response)=>{
            ...
            getNotStarted(){
                axios
                    .get('/data/client/not-completed/'+this.$parent.userId)
                    .then((response)=>{
            ...
            getCompleted(){
                axios
                    .get('/data/client/completed-projects/'+this.$parent.userId)
                    .then((response)=>{
